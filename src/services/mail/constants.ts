...
export const template = fs.readFileSync('src/services/mail/template.html').toString();
export const generalOptions = { from: 'm.vaskivnyuk@gmail.com', sender: 'You & World' };
