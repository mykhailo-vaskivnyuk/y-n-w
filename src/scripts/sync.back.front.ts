import {
  BACK_PATH, FRONT_PATH, FROM_BACK_TO_FRONT, FROM_FRONT_TO_BACK,
  EXCLUDE_FROM_BACK, EXCLUDE_FROM_FRONT, FRONT_STATIC_PATH,
  BACK_STATIC_PATH, EXCLUDE_STATIC, FILES_TO_COPY_FROM_BACK_TO_FRONT,
} from './constants';
