...
--DROP DATABASE mereganew;
--
-- TOC entry 3405 (class 1262 OID 43864)
-- Name: mereganew; Type: DATABASE; Schema: -; Owner: mereganew
--

--CREATE DATABASE mereganew WITH TEMPLATE = template0 ENCODING = 'UTF8' LOCALE = 'C';


--ALTER DATABASE mereganew OWNER TO mereganew;
...
-- Name: nets; Type: TABLE; Schema: public; Owner: mereganew
--
...
ALTER TABLE public.nets OWNER TO mereganew;

--
-- TOC entry 210 (class 1259 OID 43870)
-- Name: nets_data; Type: TABLE; Schema: public; Owner: mereganew
--
...
ALTER TABLE public.nets_data OWNER TO mereganew;

--
-- TOC entry 217 (class 1259 OID 43969)
-- Name: nets_net_id_seq; Type: SEQUENCE; Schema: public; Owner: mereganew
--
...
-- Name: nets_users_data; Type: TABLE; Schema: public; Owner: mereganew
--
...
ALTER TABLE public.nets_users_data OWNER TO mereganew;

--
-- TOC entry 212 (class 1259 OID 43890)
-- Name: nodes; Type: TABLE; Schema: public; Owner: mereganew
--
...
ALTER TABLE public.nodes OWNER TO mereganew;

--
-- TOC entry 213 (class 1259 OID 43897)
-- Name: nodes_nets; Type: TABLE; Schema: public; Owner: mereganew
--
...
ALTER TABLE public.nodes_nets OWNER TO mereganew;

--
-- TOC entry 218 (class 1259 OID 43974)
-- Name: nodes_node_id_seq; Type: SEQUENCE; Schema: public; Owner: mereganew
--
...
-- Name: nodes_users; Type: TABLE; Schema: public; Owner: mereganew
--
...
ALTER TABLE public.nodes_users OWNER TO mereganew;

--
-- TOC entry 215 (class 1259 OID 43908)
-- Name: sessions; Type: TABLE; Schema: public; Owner: mereganew
--
...
ALTER TABLE public.sessions OWNER TO mereganew;

--
-- TOC entry 219 (class 1259 OID 43979)
-- Name: sessions_session_id_seq; Type: SEQUENCE; Schema: public; Owner: mereganew
--
...
-- Name: users; Type: TABLE; Schema: public; Owner: mereganew
--
...
ALTER TABLE public.users OWNER TO mereganew;

--
-- TOC entry 220 (class 1259 OID 43980)
-- Name: users_user_id_seq; Type: SEQUENCE; Schema: public; Owner: mereganew
--
...
-- Name: nets nets_pkey; Type: CONSTRAINT; Schema: public; Owner: mereganew
--
...
-- Name: nodes nodes_pkey; Type: CONSTRAINT; Schema: public; Owner: mereganew
--
...
-- Name: sessions sessions_pkey; Type: CONSTRAINT; Schema: public; Owner: mereganew
--
...
-- Name: users ukEmail; Type: CONSTRAINT; Schema: public; Owner: mereganew
--
...
-- Name: nets_data ukNet; Type: CONSTRAINT; Schema: public; Owner: mereganew
--
...
-- Name: nets_users_data ukNetUser; Type: CONSTRAINT; Schema: public; Owner: mereganew
--
...
-- Name: nodes_nets ukNodeNets; Type: CONSTRAINT; Schema: public; Owner: mereganew
--
...
-- Name: nodes_users ukNodeUsers; Type: CONSTRAINT; Schema: public; Owner: mereganew
--
...
-- Name: users users_pkey; Type: CONSTRAINT; Schema: public; Owner: mereganew
--
...
-- Name: nodes_nets_node_id_idx; Type: INDEX; Schema: public; Owner: mereganew
--
...
-- Name: nodes_users_node_id_idx; Type: INDEX; Schema: public; Owner: mereganew
--
...
-- Name: ukNodeNet; Type: INDEX; Schema: public; Owner: mereganew
--
...
-- Name: ukNodeUser; Type: INDEX; Schema: public; Owner: mereganew
--
...
-- Name: users_email_idx; Type: INDEX; Schema: public; Owner: mereganew
--
...
-- Name: nets_data fkNetsDataNet; Type: FK CONSTRAINT; Schema: public; Owner: mereganew
--
...
-- Name: nets_users_data fkNetsUsersDataNet; Type: FK CONSTRAINT; Schema: public; Owner: mereganew
--
...
-- Name: nets_users_data fkNetsUsersDataUser; Type: FK CONSTRAINT; Schema: public; Owner: mereganew
--
...
-- Name: nodes_nets fkNodesNetsNet; Type: FK CONSTRAINT; Schema: public; Owner: mereganew
--
...
-- Name: nodes_nets fkNodesNetsNode; Type: FK CONSTRAINT; Schema: public; Owner: mereganew
--
...
-- Name: nodes_users fkNodesUsersNode; Type: FK CONSTRAINT; Schema: public; Owner: mereganew
--
...
-- Name: nodes_users fkNodesUsersUser; Type: FK CONSTRAINT; Schema: public; Owner: mereganew
--
